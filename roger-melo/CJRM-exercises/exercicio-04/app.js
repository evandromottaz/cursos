...
const my3FavoriteTVShows = ['Interstellar', 'Dr. House', 'Inceptions']
...
const isTypeSentenceMoreThan39 = typeSentence.length > 39
const stringOfTypeSentenceBool = String(isTypeSentenceMoreThan39)
// console.log(`A string que a "typeSentence" armazena tem mais de 39 caracteres? ${stringOfTypeSentenceBool.replace('t','T')}.`
...
// console.log(`Todos os ${falsyValues.length} itens do array "falsyValues" são falsy. Inclusive o ${falsyValues[7]}.`)
...
// Por que "crazyOperation" retorna 1, e 1 é um valor VERDADEIRO.

...
ulChildren.forEach(children => children.classList.add('video'))
...
const getTargetOnConsole = ({ target }) => {
  console.log(target)
}
ulChildren.forEach(children => children.addEventListener('click', getTargetOnConsole))
